  ...
  describe('basic functional test', function () {
    ...
    describe('oneof', function () {
      ...
      it('invalid', function () {
        ...
        expect(jjv.validate('user', userObject)).to.have.deep.nested.property('validation.role.owner_of');
    ...
    describe('nested objects', function () {
      ...
      it('required', function () {
        userObject.loc = {};
        expect(jjv.validate('user', userObject)).to.have.deep.nested.property('validation.loc').that.deep.equals({
      ...
      it('type', function () {
        ...
        expect(jjv.validate('user', userObject)).to.have.deep.nested.property('validation.loc.address.required');
    ...
    describe('useDefault', function () {
      ...
      it('should not overwrite with a default', function () {
        ...
        expect(err).to.have.deep.nested.property('validation.path.readings.type');
      ...
      it('should validate array items', function () {
        ...
        expect(err).to.have.deep.nested.property('validation.path.readings[0].lon.required');
      });
